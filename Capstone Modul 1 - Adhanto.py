...
def tampilkan_stok():
    ...
    if len(stok) == 0:
        ...
        while True:
            # Menampilkan menu tampilan stok
            print("----- TAMPILAN STOK -----")
            print("1. Tampilkan Per Kategori")
            print("2. Tampilkan Semua")
            print("3. Cari Dengan Keyword")
            print("4. Kembali ke Menu Utama")
            pilih_tampilan = int(input("Tampilan Stok Yang Ingin Dipilih (1-4): "))

            if pilih_tampilan == 1:
                # Menampilkan menu pilihan kategori
                print("----- PILIHAN KATEGORI -----")
                print("1. Bahan Masak")
                print("2. Minuman")
                print("3. Makanan")
                print("4. Kembali ke Menu Utama")
                pilih_kategori = int(input("Kategori Yang Ingin Ditampilkan (1-4): "))

                if pilih_kategori == 1:
                    # Menampilkan stok barang kategori Bahan Masak
                    print("Daftar Barang")
                    print("---------------------------------------------------------------------")
                    ...
                    for key in stok.keys():
                        if stok[key]["kategori"] == "Bahan Masak":
                            print("| {:12s} | {:12s} | {:12s} | {:5d} | {:12d} |".format(stok[key]["nama"], stok[key]["kemasan"], stok[key]["kategori"], stok[key]["unit"], stok[key]["harga"]))
                    print("---------------------------------------------------------------------")

                elif pilih_kategori == 2:
                    # Menampilkan stok barang kategori Minuman
                    print("Daftar Barang")
                    print("---------------------------------------------------------------------")
                    print("| Nama Barang   | Kemasan      | Kategori    | Stok  | Harga/unit   |")
                    print("---------------------------------------------------------------------")
                    ...
                    # Menampilkan stok barang kategori Makanan
                    print("Daftar Barang")
                    print("----------------------------------------------------------------------")
                    print("| Nama Barang     | Kemasan      | Kategori   | Stok  | Harga/unit   |")
                    print("----------------------------------------------------------------------")
                ...
                # Memanggil fungsi tampilkan_stok_semua untuk menampilkan semua stok barang
                tampilkan_stok_semua()

            elif pilih_tampilan == 3:
                # Mencari stok barang berdasarkan keyword
